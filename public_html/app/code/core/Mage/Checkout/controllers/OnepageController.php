...
$stock_obj = $product->getStockItem();
$product_qty_before = (int)$stock_obj->getData('qty');
...
//$stock_obj->setData('qty', $product_qty_after)->save();
$stock_obj->setData('qty', $product_qty_after)
->setData('is_in_stock', $product_qty_after > 0 ? 1 : 0)
