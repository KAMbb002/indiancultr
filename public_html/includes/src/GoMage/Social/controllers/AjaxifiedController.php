...
class GoMage_Social_AjaxifiedController extends Mage_Customer_AccountController
{
    ...
    public function preDispatch()
    {
        ...
        $pattern = '/^(validatEmail|create|login|createpost|loginpost|logoutSuccess|forgotpassword|forgotpasswordpost|confirm|confirmation|pass|wait|join|subscibeNewsletter|newAccount)/i';
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    ...
                    if ($session->getCustomer()->getIsJustConfirmed()) {
                        ...
                        $result['success'] = true;
                        $result['content']=$this->getLayout()->createBlock('page/template_links')->setName('top.links')->setTemplate('page/template/links_top.phtml')->toHtml();
           ...
           //auto subscribed to news letter
            ...
            try {
                ...
                if (true === $validationResult) {
					...
					//Mage::log($customer,null,'customerdate.log');
                    $customer->setRegisteredIp(Mage::helper('core/http')->getRemoteAddr());
                    $customer->save();
     ...
     public function forgotPasswordAction() {
        ...
        if ($email) {
            ...
            if ($customer->getId()) {
                ...
                $errors[] = $this->__('The email address you entered is not in our records.');
            }
            }
        } else {
    ...
    public function newAccountAction()
    {
         if ($this->getRequest()->isPost()) {
                ...
                $customer->setData('firstname', 'Guest')
                         ->setData('lastname', 'Guest')
                         ->setData('email', $this->getRequest()->getPost('Email'))
